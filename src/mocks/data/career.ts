    ...
    projects: [
      {
        ...
        roles: [
          '기획팀, 학적팀으로부터 요청된 비즈니스 업무 프론트 페이지 개발',
          '기획팀, 학적팀으로부터 요청된 비즈니스 업무 백엔드 API 개발',
        ],
      ...
      },
      {
        ...
        roles: [
          '개발시 필요한 전반적인 코드 표준화 작업 및 공통 기능 개발',
          '관리자 공통(공통코드, 메뉴, 권한 등) 프론트 페이지 개발',
          '관리자 공통(공통코드, 메뉴, 권한 등) 백엔드 API 개발',
        ],
      ...
      },
      {
        ...
        roles: [
          '연구과제 평가기준, 평가항목, 평가 집계 등 업무 화면 프론트 페이지 개발',
          '연구과제 평가기준, 평가항목, 평가 집계 등 업무 화면 API 개발',
        ],
        skills: ['Nexacro17', 'eGovFramework', 'Oracle'],
        intro:
      ...
      },
      {
        ...
        roles: [
          '예산 업무 파트 화면 프론트 페이지 개발',
          '예산 업무 파트 화면 백엔드 API 개발',
        ],
        skills: ['Nexacro17', 'eGovFramework', 'Oracle'],
        intro:
      ...
      },
      {
        ...
        roles: [
          '멘토링 계획서, 출석 화면 프론트 페이지 개발',
          '멘토링 계획서, 출석 화면 백엔드 API 개발',
          '개발/운영 환경 배포 및 유지 보수',
          '나눔기부 앱 유지보수',
        ],
      ...
      },
      {
        ...
        roles: [
          '입시, 장학생 선정 업무 화면 프론트 페이지 개발',
          '입시, 장학생 선정 업무 화면 백엔드 API 개발',
          '운영환경 하자보수',
        ],
